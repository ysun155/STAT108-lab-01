...
Answer: From exercise 4 and 5, since the mean is greater than median, the distribution of length is right-skewed. The center of distribution is around 0.45, and 3 outliers are identified from the boxplots. The data of length covers a large range, around 8.4. The low standard deviation 0.85 represents that data of length are clustered around the mean.
